    ...
    <article class="comment-details">
        <div class="comment-profile">
            ...
            <div class="my-comment-actions">
                ...
                <button type="button" class="edit" aria-label="edit my comment" onclick="edit(${id}, this)">
...
export function othersCloneComment(score, userImg, userName, createdAt, content, replies ,id) {
    let otherComment = `
    <section class="comment-container">
    <div class="question userQuestion">
        ...
        <article class="comment-details">
            <div class="comment-profile">
                ...
                <div class="reply">
                    <button class="replyBtn" aria-label="reply" onclick="showReplyArea(${id})">
